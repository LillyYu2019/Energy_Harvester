...
static volatile int _tachometer_edges;


class Tachometer
{
public:
	Tachometer(tachometer_pin pin, float tachometerPolePairs=1, uint16_t maxSampleTimeMillis=100, uint16_t targetSampleCount=1);
